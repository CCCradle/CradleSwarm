...
CCCradle has open-sourced a new generation intelligent agent framework called LightAgent, based on the original LightAgent project by Wanxing AI and Professor Zhang Liwen's research group. The development and implementation of LightAgent owe much to the inspiration and support from the following open-source projects, especially the outstanding projects and teams:
...
If you have any questions or suggestions, please feel free to contact CCCradle:

- **Email**: 2273077063@qq.com
- **GitHub**: [https://github.com/Cradle_Cradle/LightAgent](https://github.com/Cradle_Cradle/LightAgent)  
...
Author = {CCCradle},
Title = {LightAgent: Production-level Open-source Agentic AI Framework (Forked by CCCradle)},
Year = {2026},
}
```
